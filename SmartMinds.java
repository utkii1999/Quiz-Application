...
public class SmartMinds  extends JFrame implements ActionListener {
     JButton b1,b2;
     JTextField t1;
    SmartMinds()
    {
        ...
        ImageIcon i1= new ImageIcon(ClassLoader.getSystemResource("smart/minds/images/login.jpeg"));
        JLabel l1=new JLabel(i1);
         l1.setBounds(0, 0, 600, 500);
        add(l1);
        
        JLabel l2 = new JLabel("Smart Minds");
